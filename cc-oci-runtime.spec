...
Version  : 2.2.3
Release  : 24
URL      : https://github.com/01org/cc-oci-runtime/archive/2.2.3.tar.gz
Source0  : https://github.com/01org/cc-oci-runtime/archive/2.2.3.tar.gz
...
%prep
%setup -q -n cc-oci-runtime-2.2.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1501016051

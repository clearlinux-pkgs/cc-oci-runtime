...
Version  : 2.1.8
Release  : 22
URL      : https://github.com/01org/cc-oci-runtime/archive/2.1.8.tar.gz
Source0  : https://github.com/01org/cc-oci-runtime/archive/2.1.8.tar.gz
...
%prep
%setup -q -n cc-oci-runtime-2.1.8
...
export LANG=C
export SOURCE_DATE_EPOCH=1494619913
